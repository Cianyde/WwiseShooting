...
#include "WwiseShooting/TP_WeaponComponent.h"
...
// Cross Module References
	...
	WWISESHOOTING_API UClass* Z_Construct_UClass_UTP_WeaponComponent();
	WWISESHOOTING_API UClass* Z_Construct_UClass_UTP_WeaponComponent_NoRegister();
// End Cross Module References
	DEFINE_FUNCTION(UTP_WeaponComponent::execbeatCallBack)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->beatCallBack();
	...
	{
		P_GET_OBJECT(AWwiseShootingCharacter,Z_Param_TargetCharacter);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	void UTP_WeaponComponent::StaticRegisterNativesUTP_WeaponComponent()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "beatCallBack", &UTP_WeaponComponent::execbeatCallBack },
	...
	struct Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon_Statics
	{
		...
		{
			AWwiseShootingCharacter* TargetCharacter;
		};
	...
	struct Z_Construct_UFunction_UTP_WeaponComponent_beatCallBack_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UTP_WeaponComponent_beatCallBack_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "TP_WeaponComponent.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UTP_WeaponComponent_beatCallBack_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UTP_WeaponComponent, nullptr, "beatCallBack", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00080401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UTP_WeaponComponent_beatCallBack_Statics::Function_MetaDataParams), Z_Construct_UFunction_UTP_WeaponComponent_beatCallBack_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_UTP_WeaponComponent_beatCallBack()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UTP_WeaponComponent_beatCallBack_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_BPMsong_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_BPMsong;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTP_WeaponComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon, "AttachWeapon" }, // 2126618150
		{ &Z_Construct_UFunction_UTP_WeaponComponent_beatCallBack, "beatCallBack" }, // 2712930852
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTP_WeaponComponent_Statics::NewProp_BPMsong_MetaData[] = {
		{ "Category", "Gameplay" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Sound to play each time we fire */" },
#endif
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UTP_WeaponComponent_Statics::NewProp_BPMsong = { "BPMsong", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTP_WeaponComponent, BPMsong), Z_Construct_UClass_UAkAudioEvent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTP_WeaponComponent_Statics::NewProp_BPMsong_MetaData), Z_Construct_UClass_UTP_WeaponComponent_Statics::NewProp_BPMsong_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UTP_WeaponComponent_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UTP_WeaponComponent_Statics::NewProp_BPMsong,
	...
	template<> WWISESHOOTING_API UClass* StaticClass<UTP_WeaponComponent>()
	{
		return UTP_WeaponComponent::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UTP_WeaponComponent);
	UTP_WeaponComponent::~UTP_WeaponComponent() {}
	struct Z_CompiledInDeferFile_FID_Users_ianhu_Documents_Self_study_Github_WwiseShooting_Source_WwiseShooting_TP_WeaponComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ianhu_Documents_Self_study_Github_WwiseShooting_Source_WwiseShooting_TP_WeaponComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTP_WeaponComponent, UTP_WeaponComponent::StaticClass, TEXT("UTP_WeaponComponent"), &Z_Registration_Info_UClass_UTP_WeaponComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTP_WeaponComponent), 3008272675U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ianhu_Documents_Self_study_Github_WwiseShooting_Source_WwiseShooting_TP_WeaponComponent_h_2807707007(TEXT("/Script/WwiseShooting"),
		Z_CompiledInDeferFile_FID_Users_ianhu_Documents_Self_study_Github_WwiseShooting_Source_WwiseShooting_TP_WeaponComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ianhu_Documents_Self_study_Github_WwiseShooting_Source_WwiseShooting_TP_WeaponComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
