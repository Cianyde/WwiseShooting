...
local Plugin = {}
Plugin.name = "SpecDataReader"
Plugin.factoryheader = "../SoundEnginePlugin/SpecDataReaderSourceFactory.h"
Plugin.appleteamid = ""
Plugin.sdk = {}
Plugin.sdk.static = {}
Plugin.sdk.shared = {}
...
{
    "SpecDataReaderSourceShared.cpp"
}
