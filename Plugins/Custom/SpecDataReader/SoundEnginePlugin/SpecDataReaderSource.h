...
#ifndef SpecDataReaderSource_H
#define SpecDataReaderSource_H
...
class SpecDataReaderSource
    : public AK::IAkSourcePlugin
{
public:
    SpecDataReaderSource();
    ~SpecDataReaderSource();
