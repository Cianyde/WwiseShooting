...
#ifndef SpecDataReaderSourceParams_H
#define SpecDataReaderSourceParams_H
...
struct SpecDataReaderRTPCParams
{
    AkReal32 fDuration;
};

struct SpecDataReaderNonRTPCParams
{
};

struct SpecDataReaderSourceParams
    : public AK::IAkPluginParam
{
    SpecDataReaderSourceParams();
    SpecDataReaderSourceParams(const SpecDataReaderSourceParams& in_rParams);
    ...
    SpecDataReaderRTPCParams RTPC;
    SpecDataReaderNonRTPCParams NonRTPC;
};

#endif // SpecDataReaderSourceParams_H
