...
#ifndef SpecDataReaderConfig_H
#define SpecDataReaderConfig_H
...
namespace SpecDataReaderConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 21703;
}

#endif // SpecDataReaderConfig_H
