...
class SpecDataReaderPlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    SpecDataReaderPlugin();
    ~SpecDataReaderPlugin();
...
DECLARE_AUDIOPLUGIN_CONTAINER(SpecDataReader);	// Exposes our PluginContainer structure that contains the info for our plugin
