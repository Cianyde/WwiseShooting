...
template<> AKAUDIO_API UScriptStruct* StaticStruct<FAkSurfacePoly>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_ianhu_Documents_Self_study_Github_WwiseShooting_Plugins_Wwise_Source_AkAudio_Classes_AkSurfaceReflectorSetUtils_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ianhu_Documents_Self_study_Github_WwiseShooting_Plugins_Wwise_Source_AkAudio_Classes_AkSurfaceReflectorSetUtils_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ianhu_Documents_Self_study_Github_WwiseShooting_Plugins_Wwise_Source_AkAudio_Classes_AkSurfaceReflectorSetUtils_h_2724228405(TEXT("/Script/AkAudio"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_ianhu_Documents_Self_study_Github_WwiseShooting_Plugins_Wwise_Source_AkAudio_Classes_AkSurfaceReflectorSetUtils_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ianhu_Documents_Self_study_Github_WwiseShooting_Plugins_Wwise_Source_AkAudio_Classes_AkSurfaceReflectorSetUtils_h_Statics::ScriptStructInfo),
		nullptr, 0);
